...
public class CadenasInmutables {
    ...
    public static void main(String[] args) {
        ...
        //A class is immutable if we have two references targeting different objects of that class and when one of them swaps to the same atributes of the second, they both start targeting the same objects in memory
        ...
        System.out.println("hashcode x: " + x.hashCode() + " ; hashcode y: " + y.hashCode()); //x and y targeting diferent objects in memory

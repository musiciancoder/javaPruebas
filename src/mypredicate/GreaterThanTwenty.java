...
public class GreaterThanTwenty{
    ...
    public static void main(String[] args) {
        ...
        Predicate<Integer>p = i->i>20; //el i es un Integer. Notar q el lado izquierdo de esta expresion es un predicado, y los predicados son interfaces funcioncales, que como tal  pueden ser expresados a traves de funciones lambda (lado derecho de la expresion)

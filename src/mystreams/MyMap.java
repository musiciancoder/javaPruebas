...
public class MyMap {
    public static void main(String[] args) {
        ...
        List<User> users = personas.stream() // paso la lista de string a un stream
        ...
        users.forEach(user -> System.out.println(user.toString())); //a diferencia de map, forEach no convierte tipos
    }
